...
class UserController extends Controller
{
    ...
    {
        $user = User::all();
        return view('backend.users.list',['user'=>$user]);
    }
    ...
    public function postEdit(Request $request, $id)
    {
        ...
        $user->save();
        return redirect('admin/users/edit/'.$id)->with('thongbao','Bạn đã sửa thông tin người dùng thành công');
    }
    ...
    public function getDel($id)
    {
    	$user = User::find($id);
        $user->delete();
        return redirect("admin/users/list")->with('thongbao','Bạn đã xóa tài khoản thành công');
    }
